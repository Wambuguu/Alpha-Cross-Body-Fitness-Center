      ...
      <div className="pricing8-max-width thq-section-max-width">
        ...
        <div className="pricing8-tabs">
          ...
          {!isMonthly && (
            <button
              onClick={() => setIsMonthly(true)}
              className="pricing8-button01 thq-button-animated thq-button-outline"
            >
              <span className="thq-body-small">Monthly</span>
            </button>
          )}
          ...
          {isMonthly && (
            <button
              onClick={() => setIsMonthly(false)}
              className="pricing8-button03 thq-button-animated thq-button-outline"
            >
              <span className="thq-body-small">Yearly</span>
            </button>
          )}
        ...
        {isMonthly && (
          <div className="pricing8-container">
            <div className="pricing8-column thq-card">
              ...
              <button className="pricing8-button04 thq-button-animated thq-button-outline">
        ...
        {!isMonthly && (
          <div className="pricing8-container1">
            <div className="pricing8-column3 thq-card">
              ...
              <button className="pricing8-button07 thq-button-animated thq-button-outline">
...
Pricing8.defaultProps = {
  ...
  plan3Price: '$49/mo',
  content1: 'Pricing plans',
  plan2Feature3: 'Feature text goes here',
  plan1Feature2: 'Personalized training programs',
