      ...
      <header data-thq="thq-navbar" className="navbar4-navbar-interactive">
        ...
        <div data-thq="thq-navbar-nav" className="navbar4-desktop-menu">
          <nav className="navbar4-links">
            ...
            <Link to="/fitness-tips" className="thq-link thq-body-small">{props.link4}</Link>
            <Link to="/contact" className="thq-link thq-body-small">{props.link5}</Link>
          </nav>
          <div className="navbar4-buttons">
            <Link to="/sign-in" className="navbar4-action1 thq-button-animated thq-button-filled">
              <span className="thq-body-small">Login</span>
            </Link>
            <Link to="/sign-up" className="navbar4-action2 thq-button-animated thq-button-outline">
        ...
        <div data-thq="thq-mobile-menu" className="navbar4-mobile-menu">
          ...
          <div className="navbar4-buttons1">
            <Link to="/sign-in" className="thq-button-filled">Login</Link>
            <Link to="/sign-up" className="thq-button-outline">Register</Link>
          </div>
        </div>
      </header>
    </header>
